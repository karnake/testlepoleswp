...
$halcyon_theme_data = wp_get_theme();
if( ! defined( 'HALCYON_THEME_VERSION' ) ) define( 'HALCYON_THEME_VERSION', $halcyon_theme_data->get( 'Version' ) );
if( ! defined( 'HALCYON_THEME_NAME' ) ) define( 'HALCYON_THEME_NAME', $halcyon_theme_data->get( 'Name' ) );
...
function halcyon_scripts() {    
	...
	wp_enqueue_style( 'halcyon-google-fonts', halcyon_fonts_url() );
